    ...
    <div class="row py-3">
        <div class="col-md-4">
            ...
            <div class="card-body">
                ...
                <a href="<?php echo $row['links']; ?>" class="btn btn-primary"  style="background-color:red">Solliciteer direct!</a>
        ...
        <br>
            ...
            <div class="card-body">
                ...
                <form action="" method="POST" class="register">
                  <a href="<?php echo $row['links']; ?>" class="btn btn-primary" style="background-color:red">Solliciteer direct!</a>
                  <button type="submit" name="solliciteer" class="btn btn-warning">Solliciteer</button>
                </form>
        ...
        <div class="col-md-4">
            ...
            <img src="images/cybersecurity.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                <?php
                    $query = "SELECT * FROM vacature WHERE id='11' ";
                    $query_run = mysqli_query($connection, $query);
            ...
            <img src="images/app_ontwikkeling.jpg" class="card-img-top" alt="...">
                ...
                <h6> <?php echo $row['subtitle']; ?></h6>
                <p class="card-text"> <?php echo $row['description']; ?></p>
                <button type="button" class="btn btn-primary" name="solliciteer" style="background-color:red">Solliciteer direct!</button>
