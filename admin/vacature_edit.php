...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"> About Us Edit Page </h6>
        </div>
    ...
    if(isset($_POST['edit_vacature_btn']))
    {
        $id = $_POST['edit_id'];
    
        $query = "SELECT * FROM vacature WHERE ID='$id' ";
    ...
    {  
        ?>
            <form action="code.php" method="POST">
                ...
                <a href="vacatures_admin.php" class="btn btn-danger"> Cancel </a>
                <button type="submit" name="update_vacature_btn" class="btn btn-primary"> Update </button>
